...
function worldToPaper(position) {
    var paperPos = {
        x: position.x * metadata[viewModels[currentModel].id].scale + metadata[viewModels[currentModel].id].xoffset,
        y: position.y * metadata[viewModels[currentModel].id].scale + metadata[viewModels[currentModel].id].yoffset,
        z: metadata[viewModels[currentModel].id].paperZ
    };
...
function clientToWorld(normedPoint) {
    ...
    return {
        x: (paperPos.x - metadata[viewModels[currentModel].id].xoffset - xoffsetBox) / metadata[viewModels[currentModel].id].scale,
        y: (paperPos.y - metadata[viewModels[currentModel].id].yoffset - yoffsetBox) / metadata[viewModels[currentModel].id].scale,
        z: (viewbox.floor * metadata[viewModels[currentModel].id].floorHeight) + (metadata[viewModels[currentModel].id].floorHeight / 2 + metadata[viewModels[currentModel].id].floorBase)
    };
}
